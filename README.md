...
```
docker run -it --rm -p 9696:9696 -e RUN_ID=2d6c94443d614d5f932016056a37ad7b -e TRACKING_URI="http://host.docker.internal:5001" --add-host=host.docker.internal:host-gateway spam-prediction-service-mlflow:v1
```
